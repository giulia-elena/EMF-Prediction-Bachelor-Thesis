...
# 3. Încărcare Model RF
cale_model = os.path.join(DIR_MODELE, 'model_RF.joblib')
model = joblib.load(cale_model)

print("\nÎncepe analiza SHAP pentru Random Forest")
...
plt.title('Impactul Caracteristicilor - Model RF', fontsize=14, pad=20)
plt.tight_layout()

nume_fisier_grafic = 'Grafic_SHAP_RF.png'
